...
async function buscaDaApiExibeNaTabela() {
    const res = await fetch(`${URL_BASE_API}/funcionario/listar`);
...
async function preencheDadosParaEdicao(e) {
    ...
    const res = await fetch(`${URL_BASE_API}/funcionario/um`, opt);
    const data = await res.json();
    console.log(data);
...
async function enviaDadosParaCadastroOuEdicaoNaApi(e) {
    ...
    const res = await fetch(`${URL_BASE_API}/funcionario/${op}`, opt);
    const data = await res.json();
    e.target.reset();
...
async function solicitaExclusaoDeCartaNaApi(e) {
    ...
    const res = await fetch(`${URL_BASE_API}/funcionario/excluir`, opt);
    const data = await res.json();
    alert(data.status);
    buscaDaApiExibeNaTabela();
}
