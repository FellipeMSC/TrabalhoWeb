...
async function buscaDaApiExibeNaTabela() {
    const res = await fetch(`${URL_BASE_API}/cliente/listar`);
...
async function preencheDadosParaEdicao(e) {
    ...
    const res = await fetch(`${URL_BASE_API}/cliente/um`, opt);
    const data = await res.json();
    console.log(data);
...
async function enviaDadosParaCadastroOuEdicaoNaApi(e) {
    ...
    const res = await fetch(`${URL_BASE_API}/cliente/${op}`, opt);
    const data = await res.json();
    e.target.reset();
...
async function solicitaExclusaoDeCartaNaApi(e) {
    ...
    const res = await fetch(`${URL_BASE_API}/cliente/excluir`, opt);
    const data = await res.json();
    alert(data.status);
    buscaDaApiExibeNaTabela();
}
